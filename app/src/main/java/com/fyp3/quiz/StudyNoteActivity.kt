...
class StudyNoteActivity : AppCompatActivity() {
    ...
    companion object {
        private val TAG = StudyNoteActivity::class.java.simpleName
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinner_pdf_subtopic.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
                ...
                val pDialog2 = Utils.showProgressDialog(this@StudyNoteActivity, resources.getString(R.string.processing))

                val PostRequest = object : StringRequest(Request.Method.POST,
                        Constants.GET_PDF_LIST, Response.Listener { response ->
    ...
    private fun setupRecyclerView()
    {
        ...
        val articleAdapter = PDFListAdapter(this, arrayListPDFObject, true)
