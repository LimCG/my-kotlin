...
class FinalActivity : AppCompatActivity(), QuestionFragment.OnResultOptionListener {
    ...
    companion object {
        ...
        private val TAG = FinalActivity::class.java.simpleName
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.title = "Final Exam"
        toolbar.setNavigationOnClickListener { view ->

            onBackPressed()
        }

        val stringRequest = StringRequest(Request.Method.POST, Constants.GET_FINAL_QUESTION_URL,
        ...
        btn_pre.setOnClickListener { view ->
            ...
            {
                btn_pre.visibility = View.GONE
                btn_next.text = resources.getString(R.string.next)
            }
        ...
        btn_next.setOnClickListener { view ->
            ...
            if( questionArrayList.size - 1 > position )
            {
                ...
                {
                    btn_next.text = resources.getString(R.string.submit)
                }
            ...
            else
            {
                ...
                val alertDialog = AlertDialog.Builder(this)
                alertDialog.setTitle(resources.getString(R.string.submit))
                alertDialog.setMessage(resources.getString(R.string.submit_answer))
                alertDialog.setPositiveButton(resources.getString(R.string.submit), DialogInterface.OnClickListener { dialogInterface, i ->

                    dialogInterface.dismiss()

                    val intent = Intent(this@FinalActivity, AnswerSheetActivity::class.java)
                    intent.putExtra("answer", questionAnswerJsonArray.toString())
                    intent.putExtra("exam_type", "final")
    ...
    override fun onBackPressed() {
        ...
        val alertDialog = AlertDialog.Builder(this)
        alertDialog.setTitle(resources.getString(R.string.alert))
        alertDialog.setMessage(resources.getString(R.string.quit))
